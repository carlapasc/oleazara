...
class Aceites extends StatefulWidget {

  @override
  _AceitesState createState() => _AceitesState();
}

class _AceitesState extends State<Aceites> {
  List data = [];
  ...
  void fetchData() async {
    var url = 'https://oleazaradatabase.000webhostapp.com/aceites.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('ACEITES'), backgroundColor: Colors.black,),
