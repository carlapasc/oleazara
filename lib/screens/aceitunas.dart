...
class Aceitunas extends StatefulWidget {

  @override
  _AceitunasState createState() => _AceitunasState();
}

class _AceitunasState extends State<Aceitunas> {
  List data = [];
  ...
  void fetchData() async {
    var url = 'https://oleazaradatabase.000webhostapp.com/aceitunas.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('ACEITUNAS'), backgroundColor: Colors.black,),
