...
class Mermelada extends StatefulWidget {

  @override
  _MermeladaState createState() => _MermeladaState();
}

class _MermeladaState extends State<Mermelada> {
  List data = [];
  ...
  void fetchData() async {
    var url = 'https://oleazaradatabase.000webhostapp.com/mermelada.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('MERMELADAS ECOLÓGICAS'), backgroundColor: Colors.black,),
