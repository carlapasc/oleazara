...
class Pates extends StatefulWidget {

  @override
  _PatesState createState() => _PatesState();
}

class _PatesState extends State<Pates> {
  List data = [];
  ...
  void fetchData() async {
    var url = 'https://oleazaradatabase.000webhostapp.com/pates.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('PATÉS'), backgroundColor: Colors.black,),
